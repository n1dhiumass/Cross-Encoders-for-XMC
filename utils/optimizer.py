...
patterns_optimizer = {
	...
	'label_token_embeds': ['bert_model.embeddings.label_token_embeds'],
	'soft_label_token_weights_per_pos': ['bert_model.embeddings.soft_label_token_weights_per_pos'],
	"soft_label_weights": ['bert_model.embeddings.soft_label_token_weights'],
}
