...
from eval.eval_utils import score_topk_preds, compute_label_embeddings, compute_input_embeddings
...
# def sample_anchor_entities():
#
# 	data_name_vals = ["military", "yugioh", "star_trek", "pro_wrestling", "doctor_who"]
# 	num_ent_to_sample = 1000
...
# 		n_ents = N_ENTS_ZESHEL[data_name]
#
# 		ent_list = rng.choice(n_ents, size=num_ent_to_sample, replace=False).tolist()
#
# 		result = {num_ent_to_sample:ent_list}
#
# 		res_file = f"{res_dir}/{data_name}/anchor_ents.json"
